    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between p-6 border-b border-green-pale/30">
          ...
          <button onClick={() => setCartOpen(false)} aria-label="Close cart" title="Close cart" className="p-2 rounded-full hover:bg-green-pale/30 transition-colors">
                ...
                <motion.div key={item._id} layout initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="flex gap-4 p-3 rounded-2xl bg-cream/60 border border-green-pale/20">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-2">
                      <button
                        ...
                        className="w-7 h-7 rounded-full border border-green-pale flex items-center justify-center hover:bg-green hover:text-white hover:border-green transition-colors"
                      >
                        <Minus size={12} />
                      </button>
                      ...
                      <button
                        ...
                        className="w-7 h-7 rounded-full border border-green-pale flex items-center justify-center hover:bg-green hover:text-white hover:border-green transition-colors disabled:opacity-40"
                      >
                        <Plus size={12} />
                      </button>
                    </div>
                  ...
                  <div className="flex flex-col items-end justify-between">
                    <button
                      ...
                      className="p-1.5 rounded-lg hover:bg-red-50 text-muted hover:text-red-400 transition-colors"
                    >
                      <Trash2 size={14} />
                    </button>
